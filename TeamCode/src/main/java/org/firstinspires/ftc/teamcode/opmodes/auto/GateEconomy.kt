...
@Autonomous(name="GateEconomy 21", group="Auto")
class GateEconomyRed: GateEconomy(true)

@Autonomous(name="GateEconomy 21", group="Auto")
class GateEconomyBlue: GateEconomy(false)
open class GateEconomy(isRed: Boolean): Auto(
    isRed,
    closeStartPose,
    {Race(
        Forever({
